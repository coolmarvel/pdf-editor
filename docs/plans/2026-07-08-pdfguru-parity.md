...
## pdfguru 기능 인벤토리 → 구현 상태

| pdfguru | 상태(v1.0.0) | 비고 |
|---|---|---|
...
| Rectangle / Ellipse | ✅ | |
| Cross / Check | ✅ | 클릭 배치 |
| Sign (Draw/Image/Type, 색 3종, Save Signature) | ✅ | 저장 서명은 세션 내 유지(영속화 P3) |
| Annotations (스티키 노트) | ✅ 기본형 | 아이콘 세트·색 팔레트 일부 (전체 세트 P2) |
| Links (Website/Page) | ✅ | 실제 PDF Link 주석으로 저장 |
| Page layout (Mode/Transition/Rotation) | 부분 | 회전만. Mode/Transition P2 |
